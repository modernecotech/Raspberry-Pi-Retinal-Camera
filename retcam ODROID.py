...
#uncomment the libraries below only on a ODROID C1.
#These libraries control the camera and LEDs
import RPi.GPIO as GPIO

#import UVC camera function
...
GPIO.setup(11, GPIO.OUT, initial=0) # IR LED
GPIO.setup(12, GPIO.OUT, initial=0) # white LED
...
def led_illumination_on():
        if led_illumination_string.get() == 'IR':
                print "IR" 
                GPIO.output(11,True)  #start infrared 
		GPIO.output(12,False) #stop white
        elif led_illumination_string.get() == 'WHITE':
                print "WHITE"
                GPIO.output(11,False)  #stop infrared 
		GPIO.output(12,True)   #start white
	else :
		print "OFF"
                GPIO.output(11,False)  #stop infrared 
		GPIO.output(12,False)   #stop white
